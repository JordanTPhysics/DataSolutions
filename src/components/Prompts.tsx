    ...
    <>
      <ul className="text-left flex flex-col justify-evenly text-lg lg:text-3xl italic font-serif">
        ...
        <li className="flex flex-row p-4 ">
          ...
          <span className="px-4 my-auto">Improve Data Literacy</span>
        </li>

        <li className="flex flex-row p-4 relative">
          <div className="twist mr-auto mx-4">
            <div className="icon-container">
              <LuSigmaSquare size={size} color="purple" className="default-icon" />
        ...
        <li className="flex flex-row p-4 ">
          <PiStrategy size={size} className="mr-auto mx-4 shift" color="teal" />
          <span className="px-4 my-auto">Strategize Marketing</span>
        </li>
